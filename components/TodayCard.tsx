...
import { MOON_MODES, type Cycle13Week, getDayOfWeek, getProgress, type MoonMode } from "@/lib/cycle13-data";
    ...
    <div className="rounded-2xl border border-[#2a2a32] bg-gradient-to-b from-[#1a1a20] to-[#15151a] p-5 sm:p-7 space-y-4">
      ...
      <div className="flex items-start gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[#e8e8ec] font-medium">
      ...
      <div className="flex gap-4 text-sm flex-wrap">
        ...
        <div>
          ...
          <span className="text-[#e8e8ec]">{suitInfo.name}</span>
        </div>
      </div>
      ...
      {/* Daily minimum */}
      <div className="rounded-lg p-4" style={{ borderColor: suitInfo.color, borderWidth: 1, background: `${suitInfo.color}10` }}>
        <div className="text-xs uppercase tracking-wider mb-1" style={{ color: suitInfo.color }}>
          Главное действие дня
        </div>
        <p className="text-[#e8e8ec] font-medium">{week.dailyMinimum}</p>
      </div>

      {/* 3 daily actions */}
      <div>
        <div className="text-xs text-[#555560] uppercase tracking-wider mb-2">3 действия на сегодня</div>
      ...
      {/* What to fix */}
      <div>
        <div className="text-xs text-[#555560] uppercase tracking-wider mb-1">Что зафиксировать</div>
        <div className="flex gap-2 flex-wrap">
