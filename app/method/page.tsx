      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <section className="rounded-lg border border-[#2a2a32] bg-[#1a1a20] p-4">
          <p className="text-[#555560] text-xs leading-relaxed">
            Cycle13 — практическая модель недельного фокуса. Она не является научным, религиозным,
            историческим или предсказательным стандартом. Её задача — помочь структурировать неделю
            через фокус, действия и результат. Лунный слой — дополнительный способ посмотреть на неделю,
            а не точный астрономический инструмент.
          </p>
        </section>
      </div>
    </AppShell>
