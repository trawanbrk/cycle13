  ...
  return (
    <AppShell>
      <div className="space-y-6 max-w-3xl">
        ...
        <div className="rounded-xl border border-[#2a2a32] bg-[#1a1a20] p-5">
          <div className="text-xs text-[#555560] uppercase tracking-wider mb-2">Масти и луна — это два разных слоя</div>
          <p className="text-[#c8c8cc] text-sm leading-relaxed">
            Масть показывает сферу недели внутри 28-дневного цикла.
            Луна показывает режим движения в текущий момент.
            Они не обязаны совпадать один к одному.
          </p>
          <p className="text-[#c8c8cc] text-sm leading-relaxed mt-2">
            Например, если неделя — Черви, а луна убывающая, это не ошибка.
            Это значит: тема людей, энергии и доверия проходит через режим завершения, очистки и честных выводов.
          </p>
          <div className="rounded-lg bg-[#0f0f12] border border-[#22222a] p-3 mt-3">
            <p className="text-[#888892] text-sm">
              <span className="text-[#B8453A] font-mono">7♥</span> + Убывающая луна = стратегия в людях и доверии через завершение, очистку и честные выводы.
            </p>
          </div>
          <p className="text-[#555560] text-xs mt-3">
            Карта недели считается по 13×28 структуре. Лунная фаза считается отдельно и добавляет режим движения. Cycle13 соединяет оба слоя в одну практическую подсказку.
          </p>
        </div>

        <p className="text-[#555560] text-xs text-center">Луна не говорит, что произойдёт. Она помогает выбрать режим движения.</p>
